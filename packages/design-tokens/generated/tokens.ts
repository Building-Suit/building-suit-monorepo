...
export const tokens = {
  ...
  "color": {
    ...
    "gradient": {
      "gold": {
        "value": "linear-gradient(135deg, #EBB45A 0%, #D89B42 50%, #A86C1C 100%)"
      },
      "navy": {
        "value": "linear-gradient(160deg, #16293B 0%, #0D1B28 100%)"
      }
    },
    "role": {
      "light": {
  ...
  "typography": {
    "fontFamily": {
      ...
      "arabic": {
        "value": "'IBM Plex Sans Arabic', Cairo, Tajawal, sans-serif"
      }
    },
    "fontWeight": {
      "regular": {
    ...
    "_note": "Arabic line-heights run +10–15% over the Latin values. Headings ~1.1–1.3; body ~1.5."
  },
  "spacing": {
    "0": {
      "value": "0px"
  ...
  "component": {
    "buttonPrimary": {
      "_note": "Primary action. Color flips by mode — Navy on light, Gold on dark.",
      "radius": {
        "value": "{radius.button}"
      },
      "paddingX": {
      ...
      "typography": {
        "value": "{typography.scale.button}"
      },
      "light": {
        "background": {
          "value": "{color.role.light.primary}"
        },
        "text": {
          "value": "{color.role.light.textOnPrimary}"
        }
      },
      "dark": {
        "background": {
          "value": "{color.role.dark.primary}"
        },
        "text": {
          "value": "{color.role.dark.textOnPrimary}"
        }
      }
    },
    "card": {
      ...
      "light": {
        "background": {
          "value": "{color.role.light.surface}"
        },
        "border": {
          "value": "{color.role.light.border}"
        },
        "shadow": {
          "value": "{shadow.elevation1}"
        }
      },
      "dark": {
        "background": {
          "value": "{color.role.dark.surface}"
        },
        "border": {
          "value": "{color.role.dark.border}"
        },
        "shadow": {
          "value": "{shadow.elevation1Dark}"
        }
      }
    },
    "input": {
      ...
      "light": {
        ...
        "text": {
          "value": "{color.role.light.text}"
        },
        "focusRing": {
          "value": "{color.role.light.focusRing}"
        },
        "error": {
      ...
      "dark": {
        ...
        "text": {
          "value": "{color.role.dark.text}"
        },
        "focusRing": {
          "value": "{color.role.dark.focusRing}"
        },
        "error": {
          "value": "{color.semantic.errorDark}"
        }
      }
    },
    "chip": {
    ...
    "modal": {
      ...
      "dark": {
        "background": {
          "value": "{color.role.dark.surfaceRaised}"
        },
        "shadow": {
