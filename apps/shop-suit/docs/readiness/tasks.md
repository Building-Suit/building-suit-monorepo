...
> Source limitation: the SS-BASE-001 attachment enumerates all 197 requirement IDs and supplies domain audit criteria, but it does not include the underlying per-ID Pack V1 wording. The short summaries below are traceability labels inferred from that brief. Where exact semantics affect classification, the status is `unverified`; future sessions must replace labels with verbatim-approved summaries when the pack is supplied, without silently inventing policy.
...
| Baseline branch | `origin/stg` (clean, current preflight; no active unmerged feature parent) |
...
| Database inspected | Checked-in four-migration chain and disposable local Shop database after applying pending local version `20260919091222` |
...
|---|---|---|
| `SS-BASE-001` | Complete in working tree; uncommitted by instruction | Evidence-backed baseline, all 197 IDs, preservation/risks/decisions, dependency plan and exact next task |
| `SS-BIZ-001` | Proposed / pending | Separate operational business mode from subscription entitlement; exact acceptance criteria below |
...
- **T1** — After locally applying pending migration `20260919091222`, `pnpm db:test:shop` passed all seven active rollback suites. Initial run failed because the disposable local instance was one migration behind; no hosted database was touched.
...
| SCOPE-03 | Stocked-product business support | P0 / scope boundary | `partially implemented` | E1,E2 | D1 | U1 | T3 | Only part/foundation of “Stocked-product business support” is connected or tested; remaining workflow/browser scope is open. | Architecture boundaries; business-mode work for SCOPE-03..05 | Preserve independent Auth/project/session and no Ledger runtime dependency. |
| SCOPE-04 | Service-only business support | P0 / scope boundary | `partially implemented` | E1,E2 | D1 | U1 | T3 | Only part/foundation of “Service-only business support” is connected or tested; remaining workflow/browser scope is open. | Architecture boundaries; business-mode work for SCOPE-03..05 | Preserve independent Auth/project/session and no Ledger runtime dependency. |
| SCOPE-05 | Mixed product-and-service support | P0 / scope boundary | `partially implemented` | E1,E2 | D1 | U1 | T3 | Only part/foundation of “Mixed product-and-service support” is connected or tested; remaining workflow/browser scope is open. | Architecture boundaries; business-mode work for SCOPE-03..05 | Preserve independent Auth/project/session and no Ledger runtime dependency. |
...
| ID | Short requirement | Priority/type | Status | Repository evidence | Database evidence | UI/workflow evidence | Test evidence | Known gap | Dependencies | Preservation/security note |
|---|---|---|---|---|---|---|---|---|---|---|
| BIZ-01 | Represent a stocked-product business | P0 / business configuration | `partially implemented` | E4,E5,E6 | D1,D6 | U1,U2 | T1,T4 | Only part/foundation of “Represent a stocked-product business” is connected or tested; remaining workflow/browser scope is open. | SS-BIZ-001 | Current Pro inventory flag is entitlement evidence, not approved business configuration. |
| BIZ-02 | Represent a service-only business | P0 / business configuration | `partially implemented` | E4,E5,E6 | D1,D6 | U1,U2 | T1,T4 | Only part/foundation of “Represent a service-only business” is connected or tested; remaining workflow/browser scope is open. | SS-BIZ-001 | Current Pro inventory flag is entitlement evidence, not approved business configuration. |
| BIZ-03 | Represent a mixed business | P0 / business configuration | `partially implemented` | E4,E5,E6 | D1,D6 | U1,U2 | T1,T4 | Only part/foundation of “Represent a mixed business” is connected or tested; remaining workflow/browser scope is open. | SS-BIZ-001 | Current Pro inventory flag is entitlement evidence, not approved business configuration. |
| BIZ-04 | Persist business mode independently | P0 / business configuration | `missing` | E4,E5,E6 | D1,D6 | U1,U2 | T1,T4 | No supported connected “Persist business mode independently” workflow exists. | SS-BIZ-001 | Current Pro inventory flag is entitlement evidence, not approved business configuration. |
| BIZ-05 | Drive operational-area visibility from business mode | P0 / business configuration | `missing` | E4,E5,E6 | D1,D6 | U1,U2 | T1,T4 | No supported connected “Drive operational-area visibility from business mode” workflow exists. | SS-BIZ-001 | Current Pro inventory flag is entitlement evidence, not approved business configuration. |
| BIZ-06 | Do not use subscription tier as business type | P0 / business configuration | `missing` | E4,E5,E6 | D1,D6 | U1,U2 | T1,T4 | No supported connected “Do not use subscription tier as business type” workflow exists. | SS-BIZ-001 | Current Pro inventory flag is entitlement evidence, not approved business configuration. |
| BIZ-07 | Change business mode without deleting history | P0 / business configuration | `missing` | E4,E5,E6 | D1,D6 | U1,U2 | T1,T4 | No supported connected “Change business mode without deleting history” workflow exists. | SS-BIZ-001 | Current Pro inventory flag is entitlement evidence, not approved business configuration. |
| BIZ-08 | Configure business mode during onboarding and later settings | P0 / business configuration | `missing` | E4,E5,E6 | D1,D6 | U1,U2 | T1,T4 | No supported connected “Configure business mode during onboarding and later settings” workflow exists. | SS-BIZ-001 | Current Pro inventory flag is entitlement evidence, not approved business configuration. |
...
| SERV-05 | Optionally model service material consumption | P0 / master data | `missing` | E5 | D3,D4 | U2 | T1,T4 | No supported connected “Optionally model service material consumption” workflow exists. | SS-BIZ-001; SS-SALE-001; later material policy | Preserve inventory-independent service catalog and validated discounts. |
...
| SALE-03 | Support approved custom/manual lines | P0 / sales | `partially implemented` | E7 | D1,D8,D9 | U4 | T2,T4 | Only part/foundation of “Support approved custom/manual lines” is connected or tested; remaining workflow/browser scope is open. | SS-BIZ-001; SS-SAFE-001; SS-CUST-001; SS-SALE-001; SS-PAY-001 | Do not call the revoked/broken legacy finalizer; preserve immutable issued-document history. |
...
| SALE-12 | Print or share a receipt/invoice | P0 / sales | `missing` | E7 | D1,D8,D9 | U4 | T2,T4 | No supported connected “Print or share a receipt/invoice” workflow exists. | SS-BIZ-001; SS-SAFE-001; SS-CUST-001; SS-SALE-001; SS-PAY-001 | Do not call the revoked/broken legacy finalizer; preserve immutable issued-document history. |
...
| SALE-14 | Void, correct, refund or return sales traceably | P0 / sales | `partially implemented` | E7 | D1,D8,D9 | U4 | T2,T4 | Only part/foundation of “Void, correct, refund or return sales traceably” is connected or tested; remaining workflow/browser scope is open. | SS-BIZ-001; SS-SAFE-001; SS-CUST-001; SS-SALE-001; SS-PAY-001 | Do not call the revoked/broken legacy finalizer; preserve immutable issued-document history. |
| SALE-15 | Apply approved VAT/tax behavior | P0 / sales | `missing` | E7 | D1,D8,D9 | U4 | T2,T4 | No supported connected “Apply approved VAT/tax behavior” workflow exists. | SS-BIZ-001; SS-SAFE-001; SS-CUST-001; SS-SALE-001; SS-PAY-001 | Do not call the revoked/broken legacy finalizer; preserve immutable issued-document history. |
...
| ID | Short requirement | Priority/type | Status | Repository evidence | Database evidence | UI/workflow evidence | Test evidence | Known gap | Dependencies | Preservation/security note |
|---|---|---|---|---|---|---|---|---|---|---|
| SET-01 | Edit shop/business profile | P1 / settings | `missing` | E7 | D1 | U5 | T4 | No supported connected “Edit shop/business profile” workflow exists. | SS-SET-001 after document contracts | EGP is currently hard-coded/defaulted; snapshots partly protect historical names. |
...
| SET-04 | Configure operational defaults | P1 / settings | `missing` | E7 | D1 | U5 | T4 | No supported connected “Configure operational defaults” workflow exists. | SS-SET-001 after document contracts | EGP is currently hard-coded/defaulted; snapshots partly protect historical names. |
...
| UX-09 | Invalidate/refetch state after writes and shop switches | P0 / product UX | `partially implemented` | E3,E4,E5,E6,E8,E9 | D1 | U1,U2 | T3,T4 | Only part/foundation of “Invalidate/refetch state after writes and shop switches” is connected or tested; remaining workflow/browser scope is open. | Per-capability work; SS-UX-001 hardening | No authenticated browser/mobile/a11y pass has been run; lists use fixed limits and client filtering. |
...
| ID | Short requirement | Priority/type | Status | Repository evidence | Database evidence | UI/workflow evidence | Test evidence | Known gap | Dependencies | Preservation/security note |
|---|---|---|---|---|---|---|---|---|---|---|
| SAFE-01 | Deny outsiders and cross-tenant reads | P0 / security and integrity | `implemented` | E3,E4,E5,E6,E8,E9 | D2,D3,D5,D6,D7,D8,D9 | U2,U4 | T1,T2,T4 | Bounded criterion evidenced for “Deny outsiders and cross-tenant reads”; preserve it while completing adjacent workflow. | SS-SAFE-001 plus each domain package | Supported RPCs are safer; legacy sales lint defect and non-composite cross-shop FKs remain blockers. |
| SAFE-02 | Reject cross-shop foreign references | P0 / security and integrity | `partially implemented` | E3,E4,E5,E6,E8,E9 | D2,D3,D5,D6,D7,D8,D9 | U2,U4 | T1,T2,T4 | Only part/foundation of “Reject cross-shop foreign references” is connected or tested; remaining workflow/browser scope is open. | SS-SAFE-001 plus each domain package | Supported RPCs are safer; legacy sales lint defect and non-composite cross-shop FKs remain blockers. |
| SAFE-03 | Enforce active membership and profile status | P0 / security and integrity | `implemented` | E3,E4,E5,E6,E8,E9 | D2,D3,D5,D6,D7,D8,D9 | U2,U4 | T1,T2,T4 | Bounded criterion evidenced for “Enforce active membership and profile status”; preserve it while completing adjacent workflow. | SS-SAFE-001 plus each domain package | Supported RPCs are safer; legacy sales lint defect and non-composite cross-shop FKs remain blockers. |
...
| SAFE-07 | Prevent duplicate or inconsistent payments | P0 / security and integrity | `missing` | E3,E4,E5,E6,E8,E9 | D2,D3,D5,D6,D7,D8,D9 | U2,U4 | T1,T2,T4 | No supported connected “Prevent duplicate or inconsistent payments” workflow exists. | SS-SAFE-001 plus each domain package | Supported RPCs are safer; legacy sales lint defect and non-composite cross-shop FKs remain blockers. |
| SAFE-08 | Protect finalized documents, numbering and retries | P0 / security and integrity | `partially implemented` | E3,E4,E5,E6,E8,E9 | D2,D3,D5,D6,D7,D8,D9 | U2,U4 | T1,T2,T4 | Only part/foundation of “Protect finalized documents, numbering and retries” is connected or tested; remaining workflow/browser scope is open. | SS-SAFE-001 plus each domain package | Supported RPCs are safer; legacy sales lint defect and non-composite cross-shop FKs remain blockers. |
...
| SAFE-10 | Preserve audit and historical records | P0 / security and integrity | `partially implemented` | E3,E4,E5,E6,E8,E9 | D2,D3,D5,D6,D7,D8,D9 | U2,U4 | T1,T2,T4 | Only part/foundation of “Preserve audit and historical records” is connected or tested; remaining workflow/browser scope is open. | SS-SAFE-001 plus each domain package | Supported RPCs are safer; legacy sales lint defect and non-composite cross-shop FKs remain blockers. |
...
| VAL-02 | Inspect effective migration-chain schema | Validation / evidence | `implemented` | E11 | D1 | U1,U2,U4 | T1,T2,T3,T4,T5 | Bounded criterion evidenced for “Inspect effective migration-chain schema”; preserve it while completing adjacent workflow. | Exact pack attachment for VAL-01; implementation packages for remaining gaps | This baseline made no hosted or provider changes. |
...
| VAL-09 | Verify expense and purchase invariants | Validation / evidence | `implemented` | E11 | D1 | U1,U2,U4 | T1,T2,T3,T4,T5 | Bounded criterion evidenced for “Verify expense and purchase invariants”; preserve it while completing adjacent workflow. | Exact pack attachment for VAL-01; implementation packages for remaining gaps | This baseline made no hosted or provider changes. |
...
| VAL-11 | Run bilingual, RTL/LTR and responsive manual checks | Validation / evidence | `missing` | E11 | D1 | U1,U2,U4 | T1,T2,T3,T4,T5 | No supported connected “Run bilingual, RTL/LTR and responsive manual checks” workflow exists. | Exact pack attachment for VAL-01; implementation packages for remaining gaps | This baseline made no hosted or provider changes. |
...
- Manual: product/service/mixed onboarding and switch review in Arabic/English, mobile/desktop, refresh/shop-switch.
...
- Components/schema: composite/trigger validation where compatible, private helper contracts, explicit grants and negative tests.
- Risks/preservation: inventory/audit history and existing copied rows; forward-only migrations and preflight reconciliation.
- Acceptance/testing: catalog dependency review; outsider/cross-shop/service-role grant regression; no rewrite of applied migrations.
...
- Schema: checked customer commands, same-shop constraints/indexes, due-date/document contract if approved.
- Tests/manual: tenant, archive/history, server pagination, owner/delegated permissions, bilingual browser journey.
- Decisions: payment overage/reversal can remain deferred.
...
- Schema: forward command contract, request ledger/key, immutable issued header/lines, safe inventory locks and snapshots.
- Tests/manual: retry/concurrency, insufficient stock, service-only/mixed, cross-shop references, closed period, expiry/permission, full owner/staff browser issue/detail flow.
- Decisions: custom lines and tax excluded until explicitly approved.
...
- Tests/manual: idempotency, over-allocation policy, closed period, cross-shop denial, concurrent receipt, invoice/customer balances.
...
- Preserve: existing Task 09b posting/idempotency/FIFO/immutability.
...
- Tests/manual: concurrent counts/sales, negative prevention, archived products, traceable references, valuation reconciliation.
...
- Tests/manual: invite races/seat quotas, escalation denial, open-session suspension and cross-shop isolation.
...
- Tests/manual: known fixtures, pagination boundaries, timezone/date filters, CSV, RTL/mobile.
...
- Preserve: history, idempotent resource usage and no self-upgrade.
...
- Decisions: supported currencies and tax/document presentation.
...
- Tests/manual: keyboard/focus/a11y, responsive layouts, translated copy and shop/account cache invalidation.
...
Dependency justification: current code can hold both catalogs, but it has no business configuration and uses a Pro inventory feature as the only operational-area discriminator. Sales navigation and later reports cannot safely represent product-only, service-only and mixed businesses until that concern is explicit. The work is independent of unresolved pricing, payment, tax and return policy, so it is the first unblocked capability.

Measurable acceptance criteria:

1. A new forward migration adds one constrained, non-null operational mode for each shop: `product`, `service` or `mixed`; existing shops receive a documented compatibility-preserving `mixed` backfill with no row deletion or catalog mutation.
2. An authenticated owner-only command creates/changes the mode under the existing active profile/membership/shop and subscription write boundary; anon, outsider, employee and cross-shop calls fail.
3. Retry with the same requested mode is idempotent; mode changes are auditable at least through actor/time fields or an append-only event suited to the repository’s audit convention.
4. Mode never changes plan, subscription, quota or `features.inventory`; selecting product/mixed cannot self-grant a paid entitlement, and service mode cannot delete or invalidate stock history.
5. Signup/first-shop setup requires a mode and creates shop, owner membership, trial and mode atomically. Existing-account onboarding and direct dashboard bootstrap use the same contract.
6. Owner settings can change mode later with a confirmation that hidden areas and records are preserved.
7. Product mode enables product/catalog and eligible inventory/purchase areas while omitting service-only navigation; service mode enables services and sales-related service areas while omitting inventory/purchases; mixed mode enables both. Subscription/permission denial still overrides visibility and writes.
8. Direct URL access never becomes an authorization boundary: hidden product/service data remains protected by current RLS/RPC permission checks.
9. Shop/account/mode changes invalidate `shop-data:*` and refetch navigation/page state without leaking the previous shop’s data.
10. New SQL tests cover backfill, owner success, identical retry, mode transition, outsider/employee/cross-shop denial and no entitlement escalation; all seven existing Shop database suites remain passing.
11. Shop typecheck, lint and production build pass.
12. Manual authenticated verification covers product/service/mixed onboarding and later switching in Arabic/English, RTL/LTR and mobile/desktop; unrun scenarios must remain explicitly unverified.
13. Documentation updates this tracker only for status/task continuity and does not claim pricing, payments, sales, reports or launch readiness.

## Baseline verification record

| Command | Working directory | Result |
|---|---|---|
| `pnpm agent:preflight` | original monorepo root | Pass; fetched live state, clean `stg` at `599a5ab`, no active unmerged feature parent, PR #17 is `stg → main` |
| `pnpm install --frozen-lockfile` | cumulative worktree | Pass; dependencies installed; prepare warned that runtime Supabase URL/key were absent |
| `pnpm db shop-suit status` | cumulative worktree | Pass; disposable local Shop project selected; no linked remote project |
| `pnpm db shop-suit start` | cumulative worktree | Pass; local-only services/database selected |
...
| first `pnpm db:test:shop` | cumulative worktree | Fail: local instance lacked checked-in migration `20260919091222`; supplier RPC absent |
| `pnpm db shop-suit migration list --local` | cumulative worktree | Pass; showed first three applied and `20260919091222` pending |
| `pnpm db shop-suit migration up --local` | cumulative worktree | Pass; applied only `20260919091222_supplier_purchases.sql` to disposable local DB |
| second `pnpm db:test:shop` | cumulative worktree | Pass; seven active SQL suites passed and rolled back fixtures |
