> Imported evidence from the standalone Ledger UI-02A branch. Screenshots and earlier checks describe that source revision; monorepo validation is recorded in `docs/integrations/ledger-latest.md` at the repository root.
