...
## AS-UX-02 — نافذة CSV وقوالب وملفات بلغة المستخدم، 2026-09-19

PASS: 49 unit و27 browser وcheck/lint/typecheck/build. الاختبار الحقيقي باللغتين ينزل القالب ويستورد ويرحل صفين ويعيدهما كتكرار دون معاملات إضافية، ويفحص الخلايا الأصلية والفلاتر وتنزيل التقارير الخمسة. اختبارات التأخير والحصة والرفض تستخدم fixtures صريحة ولا تدعي إثبات RLS جديدًا. SQL لم يتغير ولم يُعد تشغيله. أُصلحت استعادة تركيز النافذة وسباق تحديث الحصة؛ [الحزمة](work-packages/AS-UX-02.md) و[الدليل](../evidence/as-ux-02/README.md). لا تغيير لقبول ق٠١–ق٢٤ أو ادعاء UAT/نشر.
