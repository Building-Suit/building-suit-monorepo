...
| JRN-08 | Permission/status/period-aware actions | P0 | current-model behavior implemented locally — reverse requires capability+posted status and UI honors basic lock/override; final period-state matrix remains V2-IMP-004/V2-D07 | DB-AUTH; DB-POST; UI-JRN; T-JRN | Backend remains authoritative; no posted-edit path was added |
