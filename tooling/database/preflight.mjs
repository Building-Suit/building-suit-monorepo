...
try {
  ...
  if (!Object.hasOwn(registry.products, product || '') || !['production', 'staging'].includes(environment)) throw new Error('Usage: pnpm db:preflight <ledger-suit|shop-suit> <production|staging>')
